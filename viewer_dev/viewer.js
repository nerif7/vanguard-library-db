/**
 * Vanguard Library DB Viewer — DEV (feature/jp-integration branch)
 *
 * Load cards.json from GitHub raw URL, browse + filter + show stats.
 * Uses virtualized rendering for 24k+ rows.
 */

const DB_URL     = "https://raw.githubusercontent.com/nerif7/vanguard-library-db/feature/jp-integration/cards.json";
const COMMIT_API = "https://api.github.com/repos/nerif7/vanguard-library-db/commits?path=cards.json&sha=feature%2Fjp-integration&per_page=1";
